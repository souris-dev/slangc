...
public:
  enum {
    ...
    TRUE = 28, FALSE = 29, BINAND = 30, BINOR = 31, BINXOR = 32, BINNOT = 33, 
    RIGHTARROW = 34, IF = 35, ELSE = 36, FUNCDEF = 37, VARDEF = 38, COLON = 39, 
    STATEMENTEND = 40, WHILE = 41, RETURN = 42, INTTYPE = 43, STRINGTYPE = 44, 
    BOOLTYPE = 45, VOIDTYPE = 46, NULLVALUE = 47, DECINT = 48, IDENTIFIER = 49, 
    STRING = 50, COMMA = 51, NEWLINE = 52, TAB = 53, WHITESPACE = 54, OTHER = 55
  };
